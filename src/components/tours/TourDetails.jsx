...
// import { useParams } from "react-router-dom"; // To get tour ID from URL
// import axios from "axios"; // For fetching tour data

// const TourDetails = () => {
//   const { id } = useParams(); // Get the tour ID from the route parameter
//   const [tourDetails, setTourDetails] = useState(null); // State to hold tour details

//   Fetch tour details when component mounts
//     useEffect(() => {
//       const fetchTourDetails = async () => {
//         try {
//           const response = await axios.get(`/api/tours/${id}`); // Fetch the tour data from API
...
//       <h1 className="text-3xl font-bold text-center mb-8">Tour Details</h1>
...
//         {/* Images */}
//         <div className="sm:col-span-2 mb-4">
//           <h2 className="text-lg font-semibold">Tour Images</h2>
